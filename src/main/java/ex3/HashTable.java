...
public class HashTable {
    ...
    public void put(String key, String value) {
        ...
        if(entries[hash] == null) {//si el hash esta vacio lo añadimos
...
//    }
    ...
    public String get(String key) {
        ...
        if(entries[hash] != null) {
            HashEntry temp = entries[hash];//No continua lleyendo

            while( !temp.key.equals(key))
                temp = temp.next;

            return temp.value;//si lo encuentra retorna el valor
        }
    ...
    public void drop(String key) {
        ...
        int hash = getHash(key);//buscamos donde esta la key
        if(entries[hash] != null) {//comprobamos el hash y si se encuentra algo dentro

            HashEntry temp = entries[hash];  //Comprueba que la key que esta leyendo no sea igual que la key seleccionada
    ...
    private HashEntry gh(String key, HashEntry temp) {
        while (!temp.key.equals(key) && temp.next != null)// si hay una linea creada que no haga nada
            temp = temp.next;
        return temp;
    }
